...
LOCAL_APPS = [
    ...
    "src.bids.apps.BidsConfig",
    "src.contact.apps.ContactConfig",
    "src.winner.apps.WinnerConfig",
    "src.adminauction.apps.AdminauctionConfig",
]
...
TEMPLATES = [
    {
        ...
        "OPTIONS": {
            ...
            "context_processors": [
                ...
                "src.users.context_processors.show_badges",
                "src.adminauction.context_processors.theme",
                "src.adminauction.context_processors.site_name",
            ],
        },
    },
]
...
ADMINS = [("""Fernando Lozano""", "fer.lozano10@hotmail.com")]
# https://docs.djangoproject.com/en/dev/ref/settings/#managers
MANAGERS = [("""your name """, "your@email.com ")]
...
# uncomment this for emailing
CELERY_TASK_ALWAYS_EAGER = True
CELERY_BROKER_CONNECTION_RETRY_ON_STARTUP = True
# CELERY_IMPORTS = ("src.adminauction.tasks", )
